...
--isthrok = true
    ...
    tobject_enable(action_followNED_button, follow.params_initialized)
    tobject_enable(action_followREL_button, follow.params_initialized)
