...
local function drawHud()
    drawHudFrameAt(draw.xmid, 22, 146)
    drawHudCompassRibbonAt(draw.xmid, 22) --draw.compassRibbonY)
    drawHudGroundSpeedAt(draw.xmid - 120, 80) --draw.groundSpeedY)
    drawHudAltitudeAt(draw.xmid + 120, 80) --draw.altitudeY)
    drawHudVerticalSpeedAt(draw.xmid, 150) --draw.verticalSpeedY)
end    
...
local function drawBatteryCharge(x,y)
...
local function drawBatteryStatus()
    ...
    drawBatteryCharge(draw.xsize, 135)
end
...
local function drawStatusBar2()
    drawStatusBar2(draw.statusBar2Y)
end
