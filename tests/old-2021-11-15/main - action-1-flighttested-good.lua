...
----------------------------------------------------------------------
local versionStr = "0.30.11 2021-07-31"
...
local function playTakeOff() end --play("takeoff") end    
...
local function doPageAction()
    ...
    local istakeoffable = --isarmed and status_g.posfix and 
        isCopter() and mavsdk.isReceiving() and
            (mavsdk.getFlightMode() ==  apCopterFlightMode.PosHold or
            mavsdk.getFlightMode() ==  apCopterFlightMode.Guided or
            mavsdk.getFlightMode() ==  apCopterFlightMode.Loiter)
    tobject_enable(action_takeoff_button, istakeoffable)
    ...
    for i = 0,2 do
      if action.mag[i].cal_status ~= nil then 
        ...
        if action.mag[i].cal_status < 4 then
