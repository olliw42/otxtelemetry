...
local function widgetRefresh(widget)
    ...
    lcd.drawText(x, y+100, "myDeltaX:", CUSTOM_COLOR)
    lcd.drawText(x, y+120, "myDeltaY:", CUSTOM_COLOR)
    lcd.drawText(x, y+140, "myEvent:", CUSTOM_COLOR)
    ...
    lcd.drawNumber(x+100, y+100, touch.myDeltaX, CUSTOM_COLOR)
    lcd.drawNumber(x+100, y+120, touch.myDeltaY, CUSTOM_COLOR)
    lcd.drawNumber(x+100, y+140, touch.myEvent, CUSTOM_COLOR)

    lcd.drawText(x, y+180, "event:", CUSTOM_COLOR)
    lcd.drawNumber(x+100, y+180, event, CUSTOM_COLOR)
