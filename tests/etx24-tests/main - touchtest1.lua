...
local function widgetUpdate(widget, rect, options)
    widget.rect.h = 50
end
...
local function widgetRefresh(widget, rect, xyz)
    local res = 0
    ...
    touch.event = xyz.t_event
    touch.x = xyz.t_x
    touch.y = xyz.t_y
    touch.startX = xyz.t_startX
    touch.startY = xyz.t_startY
    touch.deltaX = xyz.t_deltaX
    touch.deltaY = xyz.t_deltaY
    ...
    local y = 20;
    lcd.setColor(CUSTOM_COLOR, p.WHITE)
    lcd.drawText(x, y, "event:", CUSTOM_COLOR)
    lcd.drawText(x, y+20, "x:", CUSTOM_COLOR)
    lcd.drawText(x, y+40, "y:", CUSTOM_COLOR)
    lcd.drawText(x, y+60, "startX:", CUSTOM_COLOR)
    lcd.drawText(x, y+80, "startY:", CUSTOM_COLOR)
    lcd.drawText(x, y+100, "deltaX:", CUSTOM_COLOR)
    lcd.drawText(x, y+120, "deltaY:", CUSTOM_COLOR)
    
    if touch ~= nil then
      lcd.drawNumber(x+100, y, touch.event, CUSTOM_COLOR)
      lcd.drawNumber(x+100, y+20, touch.x, CUSTOM_COLOR)
      lcd.drawNumber(x+100, y+40, touch.y, CUSTOM_COLOR)
      lcd.drawNumber(x+100, y+60, touch.startX, CUSTOM_COLOR)
      lcd.drawNumber(x+100, y+80, touch.startY, CUSTOM_COLOR)
      lcd.drawNumber(x+100, y+100, touch.deltaX, CUSTOM_COLOR)
      lcd.drawNumber(x+100, y+120, touch.deltaY, CUSTOM_COLOR)
    end
    
    lcd.drawText(x, y+160, "event:", CUSTOM_COLOR)
    lcd.drawNumber(x+100, y+160, event, CUSTOM_COLOR)
