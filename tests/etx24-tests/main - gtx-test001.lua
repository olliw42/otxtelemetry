...
local function widgetRefresh(widget)
    ...
    lcd.setColor(CUSTOM_COLOR, p.YELLOW)
    lcd.drawCircle(230, 70, 50, CUSTOM_COLOR)
    lcd.setColor(CUSTOM_COLOR, p.WHITE)
    lcd.drawCircleLOUI(230, 70, 50, CUSTOM_COLOR)
    
    lcd.setColor(CUSTOM_COLOR, p.YELLOW)
    lcd.drawFilledCircle(110, 180, 50, CUSTOM_COLOR)
    lcd.setColor(CUSTOM_COLOR, p.WHITE)
    lcd.drawCircle(110, 180, 48, CUSTOM_COLOR)
    
    lcd.setColor(CUSTOM_COLOR, p.YELLOW)
    lcd.drawFilledCircleLOUI(230, 180, 50, CUSTOM_COLOR)
    lcd.setColor(CUSTOM_COLOR, p.WHITE)
    lcd.drawCircleLOUI(230, 180, 48, CUSTOM_COLOR)
