...
-- libraries: tobject.lua, tvehicle.lua, tplay.lua, tautopilot
...
-- you are free to modify as you want it to be :)
...
if config_g.showCameraPage then
    ...
    cameraDoAlways,
    doPageCamera
    = loadLib("tcamera.lua", config_g, status_g, p, draw, play, drawWarningBox, getCameraIdStr, timeToStr, touchEventTap, tobjstate, tobject, tmenu)
end
...
if config_g.showActionPage then
    ...
    actionDoAlways,
    doPageAction
    = loadLib("taction.lua", status_g, p, draw, play, tobject, tbutton, tbuttonlong, tmenu, apCopterFlightMode)
end
