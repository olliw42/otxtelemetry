...
-- requires MAVLink-OpenTx version: v26
--
-- Documentation:
--
-- Discussion:
...
----------------------------------------------------------------------
local versionStr = "0.26.1 2021-03-21"
...
local apCopterPrearmChecks = {}
apCopterPrearmChecks[0]   = { "Barometer", 1 }
apCopterPrearmChecks[1]   = { "Compass", 2 }
apCopterPrearmChecks[2]   = { "GPS Lock", 4 }
apCopterPrearmChecks[3]   = { "INS", 8 }
apCopterPrearmChecks[4]   = { "Parameters", 16 }
apCopterPrearmChecks[5]   = { "RC Channels", 32 }
apCopterPrearmChecks[6]   = { "Board Voltage", 64 }
apCopterPrearmChecks[7]   = { "Battery Level", 128 }
apCopterPrearmChecks[8]   = { "Logging Available", 256 }
apCopterPrearmChecks[9]   = { "Saftey Switch", 512 }
apCopterPrearmChecks[10]  = { "GPS Configuration", 1024 }
apCopterPrearmChecks[11]  = { "System", 2048 }
apCopterPrearmChecks[12]  = { "Mission", 4096 }
apCopterPrearmChecks[13]  = { "Rangefinder", 8192 }

local apPrearmChecks = apCopterPrearmChecks
...
local function doLibrary(filename)
  local f = assert(loadScript("/WIDGETS/OlliwTel/"..filename..".lua"))
  collectgarbage()
  collectgarbage()
  return f()
end
...
local drawClass
local drawClassInitialized = 0

local function initializeDrawClass()
    if drawClassInitialized == 0 then
        drawClassInitialized = 1
        drawClass = doLibrary("class_draw")
        drawClass()
    end
end
